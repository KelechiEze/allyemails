...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #ffffff;">
    <table style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #ddd;" cellspacing="0" cellpadding="0">
        <tr style="background-color: #002f6c; color: #ffffff; text-align: center; padding: 20px; position: relative; min-height: 200px;">
            <td>
                <img src="TheSummit-2023-1-e1712249826695 1.png" alt="Takeover at the Summit" style="position: absolute; top: -10px; left: 10px; width: 150px;">
                <img src="Globedesign.png" alt="Globe Design" style="position: absolute; top: 50%; left: 85%; transform: translate(-50%, -50%); width: 160px; z-index: 1;">
        ...
        <tr style="padding: 20px; position: relative; text-align: center; background-color: #f9f9f9;">
            <td>
                <img src="Chess design.png" alt="Chess Design" style="width: 100px; position: absolute; top: 5px; left: 30px;">
                <img src="Chess design.png" alt="Chess Design" style="width: 100px; position: absolute; bottom: -1px; right: 30px;">
        ...
        <tr style="position: relative; text-align: center; padding: 20px;">
            <td>
                <img src="image one.jpeg" alt="Event Image" style="width: 100%; height: auto; object-fit: cover;">
                <img src="shadow frame.png" alt="Shadow Frame" style="width: 100%; height: 70%; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%) scale(-1); border-radius: 5%; z-index: 1;">
                <img src="3rd section.png" alt="Overlay Image" style="position: absolute; top: 50%; left: 50%; width: 30%; height: auto; object-fit: fill; z-index: 2; transform: translate(-50%, -50%);">
