    ...
    const emailTemplate = `
      ...
      <body style="margin: 0; padding: 0; font-family: 'Georgia', serif; background-color: #e8f4f3;">
        <table width="100%" cellpadding="0" cellspacing="0" style="padding: 20px;">
          <tr>
            <td align="center">
              <table width="600px" cellpadding="0" cellspacing="0" style="background-image: url('https://kelechieze.wordpress.com/wp-content/uploads/2024/12/shee.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center; background-color: #ffffff; border: 1px solid #dcdcdc; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
                <tr>
                ...
                <tr>
                  <td style="padding: 20px 40px; text-align: center;">
                    ...
                    <p style="margin: 10px 0 0 0;">
                      <img src="https://kelechieze.wordpress.com/wp-content/uploads/2024/12/logoi-removebg-preview.png" alt="Logan Bakery" style="width: 280px; height: 290px;">
                    </p>
                  </td>
                </tr>
                <tr>
